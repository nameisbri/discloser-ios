  ...
  return (
    <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-6">
      <div className="text-center mb-6">
        ...
        <h1 className="text-xl font-bold text-gray-900">{data.test_type}</h1>
        {data.show_name && data.display_name && (
          <p className="text-gray-500 text-sm">Shared by {data.display_name}</p>
        )}
        <p className="text-gray-400 text-xs mt-1">{formatDate(data.test_date)}</p>
      </div>
      ...
      {data.is_verified && (
        <div className="flex items-center justify-center gap-1 text-success text-sm mt-4">
